...
**GPU allocation matters.** nemotron-cascade-2-30b runs on 1x H200 GPUs with massive memory bandwidth and compute. Llama 3.2 3B runs on a single tiny MIG slice with limited resources.
